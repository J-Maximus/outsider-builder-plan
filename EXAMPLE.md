...
| Evals — 30 traces by hand, then ~100 labels, binary, split; validate the extraction judge on the held-out set; set the weekly cadence | Sept, 4 | ~4 | Husain FAQ + Field Guide; Shankar, *Who Validates the Validators?*; Huyen ch. 3–4 | one judge with TPR/TNR and the interval stated on held-out data; three consecutive weeks of 10–20 traces reviewed |
